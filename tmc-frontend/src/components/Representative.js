export default function Representative() {
  return (
    <div className="w-full px-5 md:px-8 mt-[74px] py-5 bg-white md:rounded-2xl md:mb-[100px]">
      ...
      <table className="mt-6 text-[7px] md:text-[14px] mytable w-full">
        <tbody>
          <tr className="bg-black text-white">
            <td className="p-2 rounded-tl-xl">
      ...
      <strong>Disclosure</strong> We work with a number of carefully selected
      credit providers who may be able to offer you finance for your purchase.
