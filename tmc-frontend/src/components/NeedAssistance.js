...
export default function NeedAssistance() {
  ...
  return (
    <div className="w-full bg-white rounded-lg mt-[50px] p-[24px] flex flex-col justify-center items-center">
      <h2 className="text-gray-900 text-center font-open-sans-condensed text-2xl  font-medium leading-8">
        Need Assistance?
      </h2>
      <p className="mt-2 text-black text-center font-open-sans-condensed sm:font-open-sans text-base font-normal leading-6 max-w-[377px]">
      ...
      <div className="w-full mt-6 flex flex-col md:flex-row justify-between">
        <a
          href="tel:01252943974"
          className="magicbutton text-white flex flex-row justify-center items-center py-[10px] w-full md:mt-0 mt-10 md:w-[45%] rounded-full uppercase cursor-pointer"
        ...
        <div
          ...
          className="border-2 bg-black text-white hover:bg-gray-700 flex flex-row justify-center items-center py-[10px] w-full md:mt-0 mt-10 md:w-[45%] rounded-full uppercase cursor-pointer"
        >
