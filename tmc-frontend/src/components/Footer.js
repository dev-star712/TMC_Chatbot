    ...
    <footer className="w-full  px-7 md:pl-24 md:pr-20 pt-[50px] md:pt-[100px] pb-8 md:pb-[96px]  font-inter bg-svg-background">
      <div className="w-full max-w-[1280px] mx-auto">
        <div className="w-full flex flex-wrap justify-evenly gap-4">
          <div className="w-full lg:w-fit flex flex-col md:justify-start items-center min-w-[112px]">
            <img
              id="nav-logo"
              itemProp="logo"
              alt="TMC Logo"
          ...
          <div className="w-full lg:w-fit mt-8 lg:mt-4 min-w-[290px]">
            <script
              ...
              dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                  ...
                  "@type": "AutoDealer",
                  name: "TMC Oakhanger (Head Office)",
                  url: `https://${process.env.REACT_APP_APP}/`,
                  logo: `https://${process.env.REACT_APP_CMS_API}/public/image/logo.svg`,
                  image: `https://${process.env.REACT_APP_CMS_API}/public/image/TMC.jpg`,

                  address: {
                    "@type": "PostalAddress",
                    streetAddress: "The Goodwood Building, The Yard, Oakhanger",
                    addressLocality: "Bordon",
                    postalCode: "GU35 9JU",
                  },
                  telephone: "01252 943974",
            ...
            <div className="w-full ">
              ...
              >
                <div className="w-5 h-5 flex-shrink-0 flex-grow-0">
                  <svg
                    width="20"
                    height="20"
                    className="mt-1 mr-1"
                ...
                <div className="text-left lg:hidden block w-full">
              ...
              >
                ...
                <div className="text-white">07833 280194</div>
              </a>
            </div>
          </div>
          <div className="w-full lg:w-fit mt-8 lg:mt-4 min-w-[245px]">
            <Typography
              variant="small"
              color="white"
          ...
          <div className="w-full lg:w-fit text-center mt-8 lg:mt-4 md:text-left min-w-[115px]">
            <Typography
              variant="small"
              color="white"
              className="mb-4 font-bold  text-xl"
