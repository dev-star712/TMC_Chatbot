export default function HeroSection({ img, mt, words, long = false }) {
  return (
    <div className="w-full  h-fit magicbackground flex flex-col justify-center items-center  relative md:px-10">
      <div
      ...
      <div className="w-full items-center lg:items-start flex flex-col lg:flex-row py-10 max-w-[1480px] justify-between md:px-0 ">
        {long ? (
          <h1 className="px-5  max-w-[708px] h-full sm:items-start lg:items-start items-center lg:justify-start justify-left text-white font-open-sans-condensed font-bold  leading-6 uppercase flex flex-wrap">
            {words.map((word, index) => {
              return (
                <span
                  key={index}
                  className={`${
                    index === 0 ? "lg:w-full lg:text-start text-left " : ""
