    ...
    <>
      <div className="w-full bg-white rounded-2xl p-8 flex flex-col">
        ...
        <div className="flex flex-wrap flex-row mt-8 uppercase">
          <div
            className={`mt-2 mr-3 p-2 bg-[#f6f6f6] rounded-lg uppercase ${
              lettersClicked ? "font-bold" : ""
            }`}
          >
            <label className="custom-checkboxr mr-3">
              <input
                type="checkbox"
                className="hidden"
                onChange={() => setLettersClicked(!lettersClicked)}
              />
          ...
          <div
            className={`mt-2 mr-0 md:mr-3 p-2 bg-[#f6f6f6] rounded-lg uppercase ${
              smsClicked ? "font-bold" : ""
            }`}
          >
            <label className="custom-checkboxr mr-3">
              <input
                type="checkbox"
                className="hidden"
                onChange={() => setSmsClicked(!smsClicked)}
              />
              <span className="checkmark"></span>
            </label>
            SMS
          ...
          >
            <label className="custom-checkboxr mr-3">
              <input
                type="checkbox"
                className="hidden"
                onChange={() => setPhoneClicked(!phoneClicked)}
              />
              <span className="checkmark"></span>
            </label>
            Phone
          ...
          >
            <label className="custom-checkboxr mr-3">
              <input
                type="checkbox"
                className="hidden"
                onChange={() => setEmailClicked(!emailClicked)}
              />
              <span className="checkmark"></span>
            </label>
            Email
