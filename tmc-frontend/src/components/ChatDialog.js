...
const ChatDialog = ({ isOpen, onClose }) => {
  return (
    <div
      className={`bg-white fixed sm:w-[370px] rounded-none sm:rounded-3xl shadow-lg flex flex-col  sm:right-[35px] sm:top-auto sm:left-auto sm:h-[650px] transition-all ${
        isOpen ? " z-50 inset-0  sm:bottom-11" : "block -bottom-[700px]"
      }`}
    >
        ...
        <div className="h-full bg-[#f9f9f9]  message-container flex-grow p-2 flex flex-col gap-y-4 overflow-y-auto  text-sm">
          <div className="h-full flex flex-col justify-between">
              ...
              <div className="relative self-start w-full">
                <div className=" px-3 py-2 rounded-t-xl w-full  text-black flex flex-row">
                  ...
                  <div className=" ml-4 flex flex-col">
                    ...
                    <div className="mt-2 text-[#b1aeae] text-[12px]">
                      2m ago
                    </div>
                  </div>
                </div>
                <div className="mt-2 items-end flex flex-col">
                  <div className="p-3 rounded-2xl bg-[#0449c8] text-white text-[14px]">
                    What payment method available in here?
                  </div>
                  <div className="mt-2 text-[#b1aeae] text-[12px]">
                    Just now
                  </div>
            ...
            <div className="mx-auto w-full flex flex-col items-center text-[#000000]">
              <div className="flex w-full justify-center  ">Switch to:</div>
