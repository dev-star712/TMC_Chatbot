...
const NewsDetailScreen = () => {
  ...
  const getCategories = async () => {
    try {
      const res = await getCategory({ type: "news" });
      console.log(res);
      if (res.error) {
        throw new Error(res.error.data.message);
      } else {
          ...
          <div className="m-2 bg-white">
            ...
            <Row className="mb-4" gutter={[24, 0]}>
              <Col span={3}>
                ...
                <strong style={{ color: "red" }}>*</strong>
                <p>
                  The date to show on the news article. News articles are
          ...
          <Button
            ...
            onClick={async () => {
              try {
                ...
                if (pageId === "news" && res.data.pageId) {
                  navigate(`/content/news/${res.data.pageId}?new=success`);
                  window.location.reload();
                }
                toast.success(res.data.message);
              } catch (error) {
